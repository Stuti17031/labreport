...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\student\\Desktop\\stuti-psychopy\\motor sequence learning_lastrun.py',
...
line4 = visual.Rect(
    ...
    width=(100, 10)[0], height=(100, 10)[1],
    ori=90.0, pos=(100, 0), anchor='center',
    lineWidth=1.0,     colorSpace='rgb',  lineColor='white', fillColor='white',
...
trials = data.TrialHandler(nReps=12.0, method='sequential', 
    ...
    trialList=data.importConditions('C:/Users/student/Desktop/stuti-psychopy/sequence_con.csv'),
