...
expName = 'exp-2'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\student\\Desktop\\stuti- psychopy\\orientation discrimination task_lastrun.py',
